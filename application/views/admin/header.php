							...
							<ul class="navigation navigation-main navigation-accordion">
								...
								<?php if ($level == "admin") { ?>
									<li class="<?php if ($menu == 'panel_admin' and $sub_menu == 'jurusan') {
													echo 'active';
												} ?>"><a href="panel_admin/jurusan"><i class="icon-home"></i> <span>Jurusan</span></a></li>
									<li class="<?php if ($menu == 'panel_admin' and $sub_menu == 'jurusan') {
													echo 'active';
												} ?>"><a href="panel_admin/user"><i class="icon-users4"></i> <span>Pengguna</span></a></li>
								<?php } ?>
								...
								<li class="<?php if ($menu == 'panel_admin' and $sub_menu == 'laporan_psb') {
												echo 'active';
											} ?>"><a href="panel_admin/laporan_psb"><i class="icon-pie-chart"></i> <span>Laporan PSB</span></a></li>
								<!-- /Main -->
								<!-- Data Lainnya -->
