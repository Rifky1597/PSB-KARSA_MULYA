...
jQuery(function(){
 new Highcharts.Chart({
  ...
  subtitle: {
   text: 'Jumlah Data Pendaftar Berdasarkan Pendidikan Ibu',
   x: -20
  },
  xAxis: {
   categories: [
   <?php foreach($pdd_ibu as $key => $value) {
      echo "'$key',";
    }?>
    ]
  },
