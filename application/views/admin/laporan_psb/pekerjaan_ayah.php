...
jQuery(function(){
 new Highcharts.Chart({
  ...
  subtitle: {
   text: 'Jumlah Data Pendaftar Berdasarkan Pekerjaan Ayah',
   x: -20
  },
  xAxis: {
   categories: [
   <?php foreach($pekerjaan_ayah as $key => $value) {
      echo "'$key',";
    }?>
    ]
  },
  ...
  series: [{
    ...
    data: [
        <?php
    foreach($pekerjaan_ayah as $key => $value) {
